...
let ADMIN_PASSHASH = process.env.ADMIN_PASSHASH;
if(!ADMIN_PASSHASH) {
...
// const PROJECTS_FILE = '/data/.config.projects.json';

// const fs = require('fs');
// const execSync = require('child_process').execSync;

// const proj = fs.existsSync(PROJECTS_FILE) ? fs.readFileSync(PROJECTS_FILE) : {};
// const projectPath = `/data/projects/${activeProject}`;
// const moduleInstallPath = '/data';
...
// }
// writeProjectsConfig(activeProject, credentialSecret)

// // Install packages with --prefix option to specify the installation directory
// child = execSync(`cd "${projectPath}" && npm install --prefix "${moduleInstallPath}"`, { stdio: 'inherit' });
 ...
 ******************************************************************************/
    ...
    */
    ...
    //    },
    //},
    // https://github.com/node-red/node-red-context-redis
